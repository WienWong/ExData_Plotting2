...
barplot(totEmi_Ba$x, names.arg = totEmi_Ba$Group.1, main = "Total Emissions at Baltimore City", xlab = "Year", ylab = expression('Total PM'[2.5]*" Emission (Tons)"), ylim = c(0,3500))
